...
윈도우 엑셀 기준. 홈 → 9개 화면(문제·혜택 배치·운영 시간·버스·월영교·기대효과·사후 검증·전국 진단·서식4) + 데이터 출처.
...
TAB = {'홈': NAVY, '1_문제': 'C00000', '2_혜택배치': 'C00000', '3_운영시간': 'ED7D31', '4_버스': 'ED7D31', '5_월영교': 'ED7D31',
       '6_기대효과': '548235', '7_사후검증': '548235', '8_전국진단': '7030A0', '9_서식4': '595959', '10_출처': '595959'}
...
deliv = [('결과물', '화면', '상태'),
         ...
         ('⑥ 사후 효과 검증계획', '사후 검증', '완료'),
         ('⑦ 전국 진단표', '전국 진단', '완료')]
links = [None, '2_혜택배치', '3_운영시간', '4_버스', '5_월영교', '6_기대효과', '7_사후검증', '8_전국진단']
...
# ═════════════ 10 출처 ═════════════
ws = W['10_출처']
setup(ws, '데이터 출처 · 무엇을 어디에 썼나', '한국관광 데이터랩 8종 + 타분야 7종 + 현장조사. 모든 수치는 분석 스크립트로 다시 계산할 수 있다')
src = pd.DataFrame([
...
note(ws, 27, '분석 스크립트(저장소 scripts/): 교수브리핑_수치.py · 이어드림_파라미터추정.py · 이어드림_시뮬레이션.py · 이어드림_사후검증_패널.py · 이어드림_사후검증_합성통제.py · 이어드림_순차도입_검정력.py · 전국진단표.py · 교수님_통합대시보드.py', 34, size=9)
